...
class ConfirmationButtons extends Component {
  ...
  handleClick() {
    this.setState({ isLoading: true }, () => {
      ...
      sendRequest(`https://meeting-assistant-backend.herokuapp.com/api/meeting/confirmation/${this.props.meetingid}?start=${this.props.start}&end=${this.props.end}`).then(() => {
